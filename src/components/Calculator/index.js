...
export default function Calculator() {
  ...
  return (
    <Container>
      ...
      <Button onClick={handleClear} special>
        c
      </Button>
      <Button data={"+/-"} onClick={positiveNegative} special>
        +/-
      </Button>
      <Button data={"%"} onClick={percentage} special>
        %
      </Button>
      ...
      <Button data={0} gridSpan={2} onClick={appendValue} zero>
        0
      </Button>
      <Button data={","} onClick={appendValue}>
        ,
      </Button>
      <Button operation onClick={equals} equals>
        =
      </Button>
    </Container>
  );
